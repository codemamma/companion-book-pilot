    ...
    <div className="min-h-screen bg-gray-950">
                ...
                <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-sm border border-gray-700">
                  <div className="bg-gray-700 aspect-[3/4] rounded-lg flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <p className="text-white font-semibold">{authorConfig.book.title}</p>
      ...
      <section className="py-20 px-4 bg-gray-950">
        <div className="max-w-5xl mx-auto">
          <h2 className="section-heading text-center mb-4">About the Author</h2>
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-white mb-4">{authorConfig.author.name}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start mt-12">
            ...
            <div className="md:col-span-2">
              ...
              <h4 className="font-semibold text-white mb-3">What You'll Gain:</h4>
      ...
      <section className="py-20 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-xl md:text-2xl font-medium mb-6 leading-relaxed text-gray-300">
