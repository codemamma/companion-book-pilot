// Author and Book Configuration
// Update all values below to customize the companion experience
...
export const authorConfig = {
  ...
  book: {
    ...
    keyTakeaways: [
      ...
      'Create sustainable change that outlasts the transformation team'
    ],
    amazonUrl: 'https://amazon.com/book-link', // Optional
    publishDate: '2024'
  },
  ...
  testimonial: {
    quote: 'The CARES framework gave me the clarity and structure I needed to lead our digital transformation. This companion makes the concepts immediately actionable.',
    attribution: 'James Chen, CIO at Fortune 100 Technology Company'
  },

  // Trust Indicators (optional)
  trustLogos: [
    // Add company logos or certifications if desired
    // { name: 'Company Name', logoUrl: '/logos/company.png' }
  ]
};
